...
$appPSHub = Start-Process -NoNewWindow powershell '-File PSHub.ps1' -PassThru
$appTicket = Start-Process -NoNewWindow powershell '-File Ticket.ps1' -PassThru
$appTicketManager = Start-Process -NoNewWindow powershell '-File TicketManager.ps1' -PassThru